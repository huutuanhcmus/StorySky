...
/**
 * Servlet implementation class UserDetailCollectionStory
 */
@WebServlet(urlPatterns = {"/tap-truyen"})
public class UserDetailCollectionStory extends HttpServlet {
     ...
     */
    public UserDetailCollectionStory() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		collectionStoryModel = collectionStoryService.findOneCollectionStoryByStoryAndCollectionStory(model.getIdStory(), model.getIdCollectionStory());
		request.setAttribute("colectionStory", collectionStoryModel);	
		request.setAttribute("story", storyModel);	
		RequestDispatcher rd = request.getRequestDispatcher("/views/user/detailcollectionstory.jsp");
